...
const DEFAULT_ROLES = [
...

  {
    ...
    permissions: [
      ...
      'ACCOUNT_READ', 'ACCOUNT_CREATE', 'ACCOUNT_MODIFY',
...

  {
    ...
    permissions: [
      'EMPLOYEE_READ', 'EMPLOYEE_CREATE', 'EMPLOYEE_MODIFY', 'ORG_READ', 'SETTINGS_READ',
      'LEAVE_READ', 'LEAVE_CREATE', 'LEAVE_MODIFY', 'LEAVE_APPROVE',
      'STAFF_ATTENDANCE_READ', 'STAFF_ATTENDANCE_CREATE', 'STAFF_ATTENDANCE_MODIFY',
    ],
  },
